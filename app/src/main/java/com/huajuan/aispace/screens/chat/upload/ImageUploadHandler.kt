...
private const val TAG = "ImageUploadHandler"
...
class ImageUploadHandler(
    ...
    suspend fun sendImageMessage(
        ...
        assistantId: String = repository.getCurrentAssistantId(),
        text: String,
        ...
        // 更新聊天状态
        val currentMessages = repository.getMessagesAsync(conversationId, assistantId)
